...
export default function ResearchDetail({ paper }) {
  ...
  return (
    <div className="research-detail-shell">
      <header className="detail-header"><div className="container detail-nav"><Logo /><a className="detail-back" href="/achievements"><span aria-hidden="true">←</span> Back to achievements</a></div></header>
